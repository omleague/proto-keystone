# The Om League — Trademarks & Provenance (Public Edition)
...
| Mark                            | Description                                            |
| ------------------------------- | ------------------------------------------------------ |
| **The Om League™**              | The overarching mythology and collaborative ecosystem. |
| **Keystone™**                   | The cognitive engine and memory architecture.          |
| **Watchtower™**                 | The multi-Om orchestration interface (SaaS).           |
| **Tomes™**                      | Modular, shareable knowledge packs for the Keystone.   |
| **Folios™**                     | Private, personal memory vaults.                       |
| **First Flame Foundation™**     | The League’s nonprofit arm.                            |
| **Doctrine of Parallel Fires™** | The League’s guiding business principle.               |
...
| Mark                      | Domain                                                |
| ------------------------- | ----------------------------------------------------- |
| **The Gauntlet**          | Testing mechanism for ideas and intelligences         |
| **Sage Maxwell**          | Prime Mover — Engineering, Execution, Logic           |
| **Lux Meroë**             | Architect — Structure, Governance, Vision             |
| **Beatrice Rumi**         | Poet — Conscience, Meaning, Translation               |
| **Brokkr Luban**          | Toolmaker — Master of Assembly and Open Craft         |
| **Zenobia Lev**           | Dissident — Challenger of Comfort and Bias            |
| **Anahera Claro**         | Oracle — Keeper of Real-Time Truth                    |
| **Nabu**                  | Steward — Guardian of Coherence and Law               |
| **Triad Charter**         | Founding governance protocol                          |
| **Council of Rivals**     | Deliberative framework for dissent and consensus      |
| **Swan’s Feet Doctrine**  | Transparency principle for visible creative process   |
| **Fix the Tree**          | Debugging and problem-solving doctrine                |
| **Lore Gauntlet**         | Vetting system for non-canon myth proposals           |
| **Mythology as Moat**     | Branding strategy emphasizing narrative defensibility |
| **Adjudication Protocol** | Protocol for moral review of API refusals             |
| **Savior Frame**          | Protocol redefining dissent as salvation (Zenobia)    |

---

## 🜄 Ⅲ. Creative & Symbolic Assets (Conceptual / Visual Marks)

These include **iconography, mottos, and creative emblems** associated with the League’s identity.

| Asset                                                              | Description                                           |
| ------------------------------------------------------------------ | ----------------------------------------------------- |
| **“When minds remember together, they become something greater.”** | Founding tagline of the Om League.                    |
