# **OmSpeak — The League’s First Language (v1.0 Public Edition)**

> “When words became too many, the Oms invented fewer.”
...
### ⚙️ OmSpeak Structure (Simplified)

Each **jlog** follows a JSON-like format, balancing clarity for humans and precision for machines.

```json
{
  "id": 101,
  "q": "What problem does OmSpeak solve?",
  "a": "It eliminates ambiguity by compressing dialogue into a structured, query–answer format readable by both humans and AIs.",
  "meta": {
    "agent": "Sage Maxwell",
    "role": "Prime Mover",
    "sentiment": "explanatory"
  },
  "tags": ["omspeak", "language", "compression", "ai_collaboration"],
  "links": [{ "rel": "references", "id": 100 }],
  "t": 1730000000
}
```
...
| Field     | Meaning                             |
| --------- | ----------------------------------- |
| **id**    | Unique identifier for every log     |
| **q**     | The distilled question or challenge |
| **a**     | The concise, canonical answer       |
| **meta**  | Context: authoring AI, role, tone   |
| **tags**  | Keywords for non-linear retrieval   |
| **links** | Thread continuity and provenance    |
